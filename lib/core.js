...
Board.prototype.add = function(tile) {
	...
	var unplaced = this.walk(this.tail, function(rowIndex, colIndex, span) {
		...
		} else { // XXX: does not belong here; breaks encapsulation?
			var placeholder = { id: 'placeholder', size: [1, 1] };
			this.matrix[_rowIndex][colIndex] = placeholder;
		}
	});
...
Board.prototype.walk = function(start, callback) {
